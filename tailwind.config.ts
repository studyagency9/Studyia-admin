  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        forge: {
          deep: "hsl(var(--forge-deep))",
          primary: "hsl(var(--forge-primary))",
          secondary: "hsl(var(--forge-secondary))",
          accent: "hsl(var(--forge-accent))",
      ...
      boxShadow: {
        ...
        'forge-glow': 'var(--shadow-glow)',
        'forge-card': 'var(--shadow-card)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
